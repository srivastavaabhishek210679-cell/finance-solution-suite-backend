...
apiRouter.use('/preferences', require('./routes/preferences.routes').default);
  ...
  apiRouter.use('/document-mgmt', require('./routes/documents.routes').default);
  apiRouter.use('/risk-mgmt', require('./routes/risks.routes').default);
  ...
  apiRouter.use('/business-analytics', require('./routes/analytics.routes').default);  apiRouter.use('/calendar', require('./routes/calendar.routes').default);
  apiRouter.use('/kpi-targets', require('./routes/kpiTarget.routes').default);
  apiRouter.use('/scheduled-reports', require('./routes/scheduledReport.routes').default);
  apiRouter.use('/bulk-import', require('./routes/bulkImport.routes').default);  apiRouter.use('/invoice-gen', require('./routes/invoiceGen.routes').default);
  apiRouter.use('/po-gen', require('./routes/poGen.routes').default);
  apiRouter.use('/approvals', require('./routes/approval.routes').default);
  apiRouter.use('/notifications', require('./routes/notification.routes').default);
